...
#print(yamlfn)
runname.pfset(yaml_file='InputKeysGeometry_DSc100z10s0.yaml')
runname.pfset(yaml_file='InputKeysPhysics_REr.yaml')
runname.pfset(yaml_file='InputKeysConditions_DP23.yaml')
runname.pfset(yaml_file='InputKeysSolver_IN0.yaml')

#runname.dist('DS.c100s0.out.press.00250_restart.pfb')
# dist
